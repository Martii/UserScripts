          ...
          case 200:
            ...
            let updaters = {
              ...
              "AnotherAutoUpdater": {
                ...
                "securityAdvisory": {
                  "advisory": "guarded",
                  "title": "AAU, Pending trial run on NEW Server"
                },
                "separator": true
              },
              "alex7kom.ru": {
              ...
              "159301": {
                "derivative": 1,
                "textContent": 'derived AEG Userscript AutoUpdater',
                "title": 'by Timid Script (100610)',
                "rex": [
                  "^https?:\\/\\/userscripts\\.org\\/scripts\\/(?:source|version)\\/159301(?:\\/\\d+)?\\.user\\.js"
                ],
                "securityAdvisory": {
                  "advisory": "guarded",
                  "title": "i/frame vulnerability"
              ...
              "104859": {
                "derivative": 2,
                "textContent": 'Script Updater (userscripts.org)',
                "iconUrl": 'e1f6a781203fa83390a5434bac010614',
                "title": 'by Zoferos (347289)',
                "rex": [
                  "^(?:https?:\\/\\/userscripts\\.org\\/scripts\\/(?:source|version)\\/)?104859(?:\\/\\d+)?\\.user\\.js"
                ],
                "securityAdvisory": {
                  "advisory": "elevated",
                  "title": "i/frame vulnerability, possible excessive bandwith usage, derivative of Script Updater (userscripts.org), possible malicious code"
