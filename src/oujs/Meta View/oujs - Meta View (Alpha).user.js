          ...
          if (this.readyState == this.DONE) {
            ...
            switch (this.status) {
              case 200:
                ...
                var matches = responseText.match(/^(\/\/ ==UserScript==[\s\S]*?^\/\/ ==\/UserScript==)/m);
                ...
                objNodePre.textContent = JSON.stringify(parseMeta(responseText, true), null, ' ');
